...
#  Created on Fri Feb 23 19:33:39 2024                
#                                                     
#######################################################
...
set init_verilog ../netlist/riscv_core.v
...
saveDesign riscv_core
reset_parasitics
extractRC
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix riscv_core_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix riscv_core_postRoute -outDir timingReports
...
set_verify_drc_mode -disable_rules {} -check_ndr_spacing auto -check_only default -check_same_via_cell false -exclude_pg_net false -ignore_trial_route false -ignore_cell_blockage false -use_min_spacing_on_block_obs auto -report riscv_core.drc.rpt -limit 1000
verify_drc
set_verify_drc_mode -area {0 0 0 0}
reportGateCount -level 5 -limit 100 -outfile riscv_core.gateCount
saveNetlist riscv_core.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network riscv_core.sdf
write_sdf -ideal_clock_network -recompute_delay_calc my_riscv.sdf